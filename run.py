#!/usr/bin/env python3
"""Punto de entrada principal para System Monitoring"""
...
from monitor.alerts import AlertSystem
from monitor.utils import load_config, export_json, export_csv, clear_screen
from monitor.web import start_server

try:
    import keyboard
except ImportError:
    keyboard = None
    print("⚠️  Keyboard module not found. Using fallback input method.")
...
def run_cli(config):
    ...
    while running:
        ...
        if keyboard:
            ...
            # Fallback: usar input() con timeout
            print("\nPresiona Enter para continuar, o escribe 'q' para salir, 'e' para exportar")
            ...
            if user_input == 'q':
                ...
                export_json(metrics)
                export_csv(metrics)
                print("✅ Datos exportados a JSON y CSV")
                time.sleep(1)
